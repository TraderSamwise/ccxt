...
class bybit(Exchange):
    ...
    async def fetch_all_my_trades(self, symbol, since, fetch_callback=None, rate_limit_callback=None):
        market = self.market(symbol)
        if market['inverse']:
            return await super(bybit, self).fetch_all_my_trades(symbol, since, fetch_callback=fetch_callback, rate_limit_callback=rate_limit_callback)
        ...
        while True:
            ...
            page += 1
            trades = fetched_trades + trades
            if len(fetched_trades) < 200 or count >= 1000:
                break
    ...
    async def fetch_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        inverse = (marketDefined and market.get('swap') and market.get('inverse')) or (marketType == 'inverse')
        futures = (marketDefined and market.get('futures')) or (marketType == 'futures')
    ...
    async def _fetch_my_trades_helper(self, symbol=None, since=None, limit=200, params={}):
        await self.load_markets()
        request = {
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=200, params={}):
        response, market = await self._fetch_my_trades_helper(symbol, since, limit, params)
        #
        # inverse
        #
        #     {
