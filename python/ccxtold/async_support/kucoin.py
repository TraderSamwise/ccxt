...
from ccxtold.async_support.base.exchange import Exchange
import hashlib
import math
import json
...
class kucoin(Exchange):
    ...
    async def fetch_tickers(self, symbols=None, params={}):
        ...
        :param dict params: extra parameters specific to the kucoin api endpoint
        :returns dict: an array of `ticker structures <https://docs.ccxtold.com/en/latest/manual.html#ticker-structure>`
        """
        await self.load_markets()
    ...
    async def fetch_open_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        :param int params['currentPage']: *stop orders only* current page
        :param str params['orderIds']: *stop orders only* comma seperated order ID list
        :returns [dict]: a list of `order structures <https://docs.ccxtold.com/en/latest/manual.html#order-structure>`
        """
    ...
    async def fetch_order(self, id, symbol=None, params={}):
        ...
        :returns: An `order structure <https://docs.ccxtold.com/en/latest/manual.html#order-structure>`
        """
        await self.load_markets()
        request = {}
        clientOrderId = self.safe_string_2(params, 'clientOid', 'clientOrderId')
    ...
    async def withdraw(self, code, amount, address, tag=None, params={}):
        ...
        :param str|None tag:
        :param dict params: extra parameters specific to the kucoin api endpoint
        :returns dict: a `transaction structure <https://docs.ccxtold.com/en/latest/manual.html#transaction-structure>`
        """
    ...
    async def fetch_ledger(self, code=None, since=None, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the kucoin api endpoint
        :returns dict: a `ledger structure <https://docs.ccxtold.com/en/latest/manual.html#ledger-structure>`
        """
        await self.load_markets()
