...
from ccxtold.async_support.kucoin import kucoin
...
from ccxtold.base.decimal_to_precision import TICK_SIZE
...
class kucoinfutures(kucoin):
    ...
    async def fetch_accounts(self, params={}):
        ...
        :returns dict: a dictionary of `account structures <https://docs.ccxtold.com/en/latest/manual.html#account-structure>` indexed by the account type
        """
    ...
    async def fetch_status(self, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: a `status structure <https://docs.ccxtold.com/en/latest/manual.html#exchange-status-structure>`
        """
    ...
    async def create_deposit_address(self, code, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: an `address structure <https://docs.ccxtold.com/en/latest/manual.html#address-structure>`
        """
    ...
    async def fetch_order_book(self, symbol, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: A dictionary of `order book structures <https://docs.ccxtold.com/en/latest/manual.html#order-book-structure>` indexed by market symbols
        """
        await self.load_markets()
    ...
    async def fetch_ticker(self, symbol, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: a `ticker structure <https://docs.ccxtold.com/en/latest/manual.html#ticker-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request = {
    ...
    async def fetch_funding_history(self, symbol=None, since=None, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: a `funding history structure <https://docs.ccxtold.com/en/latest/manual.html#funding-history-structure>`
        """
        #
        if symbol is None:
    ...
    async def fetch_positions(self, symbols=None, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns [dict]: a list of `position structure <https://docs.ccxtold.com/en/latest/manual.html#position-structure>`
        """
        await self.load_markets()
    ...
    async def create_order(self, symbol, type, side, amount, price=None, params={}):
        ...
        :returns dict: an `order structure <https://docs.ccxtold.com/en/latest/manual.html#order-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
    ...
    async def add_margin(self, symbol, amount, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: a `margin structure <https://docs.ccxtold.com/en/latest/manual.html#add-margin-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
        uuid = self.uuid()
    ...
    async def fetch_orders_by_status(self, status, symbol=None, since=None, limit=None, params={}):
        ...
        :returns: An `array of order structures <https://docs.ccxtold.com/en/latest/manual.html#order-structure>`
        """
        await self.load_markets()
        stop = self.safe_value(params, 'stop')
    ...
    async def fetch_closed_orders(self, symbol=None, since=None, limit=None, params={}):
        ...
        :returns [dict]: a list of [order structures]{@link https://docs.ccxtold.com/en/latest/manual.html#order-structure
        """
    ...
    async def fetch_funding_rate(self, symbol, params={}):
        ...
        :param str symbol: unified market symbol
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: a `funding rate structure <https://docs.ccxtold.com/en/latest/manual.html#funding-rate-structure>`
        """
        await self.load_markets()
        request = {
    ...
    async def fetch_balance(self, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: a `balance structure <https://docs.ccxtold.com/en/latest/manual.html?#balance-structure>`
        """
        await self.load_markets()
    ...
    async def transfer(self, code, amount, fromAccount, toAccount, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: a `transfer structure <https://docs.ccxtold.com/en/latest/manual.html#transfer-structure>`
        """
    ...
    async def fetch_my_trades(self, symbol=None, since=None, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns [dict]: a list of `trade structures <https://docs.ccxtold.com/en/latest/manual.html#trade-structure>`
        """
        await self.load_markets()
        request = {
    ...
    async def fetch_trades(self, symbol, since=None, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns [dict]: a list of `trade structures <https://docs.ccxtold.com/en/latest/manual.html?#public-trades>`
        """
        await self.load_markets()
        market = self.market(symbol)
        request = {
    ...
    async def fetch_deposits(self, code=None, since=None, limit=None, params={}):
        ...
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns [dict]: a list of `transaction structures <https://docs.ccxtold.com/en/latest/manual.html#transaction-structure>`
        """
        await self.load_markets()
        request = {}
        currency = None
    ...
    async def fetch_transaction_fee(self, code, params={}):
        ...
        :param str code: unified currency code
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: a `fee structure <https://docs.ccxtold.com/en/latest/manual.html#fee-structure>`
        """
    ...
    async def fetch_market_leverage_tiers(self, symbol, params={}):
        ...
        :param str symbol: unified market symbol
        :param dict params: extra parameters specific to the kucoinfutures api endpoint
        :returns dict: a `leverage tiers structure <https://docs.ccxtold.com/en/latest/manual.html#leverage-tiers-structure>`
        """
        await self.load_markets()
        market = self.market(symbol)
