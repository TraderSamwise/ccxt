...
from ccxt.base.errors import ExchangeError, BadRequest
...
from ccxtold.base.decimal_to_precision import decimal_to_precision
from ccxtold.base.decimal_to_precision import DECIMAL_PLACES, NO_PADDING, TRUNCATE, ROUND, ROUND_UP, ROUND_DOWN
from ccxtold.base.decimal_to_precision import number_to_string
from ccxtold.base.precise import Precise
...
# ecdsa signing
from ccxtold.static_dependencies import ecdsa
from ccxtold.static_dependencies import keccak
...
class Exchange(TealstreetMixin, object):
    ...
    def __repr__(self):
        return 'ccxtold.' + ('async_support.' if self.asyncio_loop else '') + self.id + '()'
